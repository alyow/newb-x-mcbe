...
#define NL_GAMMA 1.639                 // 0.3 low ~ 2.0 high
#define NL_EXPOSURE 1.652              // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.066            // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
#define NL_NIGHT_BRIGHTNESS -0.6   // 0.0 dark ~ 2.0 bright
#define NL_CAVE_BRIGHTNESS 0.02    // 0.0 dark ~ 2.0 bright
#define NL_SHADOW_INTENSITY 0.96   // 0.0 no shadow ~ 1.0 strong shadow
...
#define NL_END_AMBIENT vec3(0.2,0.1,0.1)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.48,0.77,0.49)
#define NL_UNDERWATER_TORCH_COL vec3(1.48,0.77,0.49)
...
#define NL_DAY_HORIZON_COL   vec3(0.862,0.891,1.0)
#define NL_NIGHT_ZENITH_COL  vec3(0.0,0.002,0.004)
#define NL_NIGHT_HORIZON_COL vec3(0.06,0.12,0.20)
#define NL_DAWN_ZENITH_COL   vec3(0.16,0.17,0.41)
#define NL_DAWN_HORIZON_COL  vec3(0.894,0.521,0.092)
...
#define NL_RAINBOW_CLEAR 0.26 // 0.3 subtle ~ 1.7 bright during clear
...
#define NL_CLOUD1_DEPTH 2.2                // 0.0 no bump ~ 10.0 large bumps
...
#define NL_CLOUD2_LAYER2_THICKNESS 2.56           // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_RAIN_THICKNESS 2.2       // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_STEPS 3                  // 3 low quality ~ 16 high quality
#define NL_CLOUD2_LAYER2_SCALE vec2(0.06, 0.06)   // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_LAYER2_SHAPE 0.67               // 0.0 round ~ 1.0 box
#define NL_CLOUD2_LAYER2_DENSITY 30.0             // 1.0 blurry ~ 100.0 sharp
